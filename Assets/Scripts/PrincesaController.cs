...
public class PrincesaController : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        EnableControl(false);
        //MoveToPoints(new Vector3(-10000, 3, -10));
    }
    ...
    void Update()
    {
        ...
        //    m_NewPosition += m_Direction * (m_DracSpeed * Time.deltaTime);
        //    transform.position = m_NewPosition;

        //    //float angle = Vector3.SignedAngle(m_NewPosition, m_Direction, Vector3.up);
        //    //transform.DOLocalRotate(new Vector3(0, angle, 0), 0.3f);
        //}
